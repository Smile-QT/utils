...
from utils.general import (DATASETS_DIR, LOGGER, NUM_THREADS, check_dataset, check_requirements, check_yaml, clean_str,
                           cv2, segments2boxes, xyn2xy, xywh2xyxy, xywhn2xyxy, xyxy2xywhn, get_workers)
...
def load_cifar100(batch_size, resize=None, workers=0):
    """
    ...
    return (data.DataLoader(train_dataset, batch_size, shuffle=True,
            ...
            data.DataLoader(val_dataset, batch_size, shuffle=False,
                            num_workers=workers), train_dataset.class_to_idx)


def load_data_cifar10(batch_size, resize=None, workers=0):
    """
    ...
    return (data.DataLoader(data_train, batch_size, shuffle=True,
                            num_workers=workers),
            data.DataLoader(data_test, batch_size, shuffle=False,
                            num_workers=workers))
