...
DATASETS_DIR = ROOT.parent / 'datasets'  # datasets directory
...
def check_git_status(url="https://github.com/ultralytics/yolov5"):
    # Recommend 'git pull' if code is out of date
    msg = ', for updates see ' + url
...
def check_python(minimum='3.7.1'):
